			...
			<view class="input-content">
				...
				<view class="input-box">
					<input 
						...
						@confirm="sendMessage"
					/>
					<view class="send-btn" @click="sendMessage" :class="{ active: userInput.trim() }">
	...
	data() {
		return {
			...
			conversationFlow: {
				...
				contact: {
					message: '为了方便老师联系你，请填写联系人姓名（如"陈鹏妈妈"）',
					inputType: 'text',
					next: 'teachingMethod'
				},
				teachingMethod: {
	...
	methods: {
		...
		enableInput(step, inputType) {
			...
			if (inputType === 'community') {
				...
				this.inputPlaceholder = '请输入联系人姓名'
				this.inputHintText = '请输入联系人姓名'
				this.inputType = 'text'
				this.inputMaxLength = 20
			}

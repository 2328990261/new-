...
export default function Editor(props: EditorProps) {
  ...
  return (
    ...
    >
      {/* Always-visible batch upload button (doesn't depend on Header rendering) */}
        ...
        <>
          <div className="fixed left-4 top-1/2 -translate-y-1/2 z-30">
            <IconButton
              ...
              disabled={isProcessing || inputFileIndex <= 0}
              onClick={() => gotoInputFile(inputFileIndex - 1)}
            >
              <ChevronLeft />
            </IconButton>
          </div>
          <div className="fixed right-4 top-1/2 -translate-y-1/2 z-30">
            <IconButton
              tooltip="Next image"
              disabled={isProcessing || inputFileIndex >= inputFiles.length - 1}
              onClick={() => gotoInputFile(inputFileIndex + 1)}
            >
              <ChevronRight />
            </IconButton>

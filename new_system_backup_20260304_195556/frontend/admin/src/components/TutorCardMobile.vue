...
.tutor-card-mobile {
  ...
  position: relative;
  overflow: hidden;
  cursor: pointer; /* 添加指针样式，表明整个卡片可点击 */
}

/* 置顶卡片：红晕效果 */
.tutor-card-mobile.is-top {
...
.tutor-card-mobile.selected {
  border: 2px solid var(--primary-color, #409eff);
  background: rgba(64, 158, 255, 0.05);
}

/* 置顶且选中 */
.tutor-card-mobile.is-top.selected {
  box-shadow: 0 4px 20px rgba(245, 108, 108, 0.35),
              0 2px 8px rgba(245, 108, 108, 0.25),
...
.tutor-card-mobile:hover {
  box-shadow: var(--shadow-md, 0 4px 12px rgba(0, 0, 0, 0.15));
  transform: translateY(-1px);
}

.tutor-card-mobile:active {

...
const EmailSubscriptionManage = () => import('@/views/admin/EmailSubscriptionManage.vue')
const SubscribeMessageLog = () => import('@/views/admin/SubscribeMessageLog.vue')
...
const OrderDetail = () => import('@/views/admin/OrderDetail.vue')
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '预约详情', keepAlive: false }
      },
      {
        path: 'notification',
      ...
      },
      {
        ...
        component: EmailSubscriptionManage,
        meta: { title: '邮件订阅管理', keepAlive: true }
      },
      {
        path: 'subscribe-message-log',
        name: 'SubscribeMessageLog',
        component: SubscribeMessageLog,
        meta: { title: '订阅消息日志', keepAlive: true }
      },
      {
        path: 'email',
        name: 'EmailConfig',
